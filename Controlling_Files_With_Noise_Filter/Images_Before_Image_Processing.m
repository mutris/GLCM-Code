...
clc
ct_block = ncread('YH_median.nc','tomo_median');
...
clc
ct_b = ncread('glass_beads_median.nc','tomo');
ct_block = ct_b(:,:,1:40);
...
clearvars im_resize num_img im ct_block
clc
ct_block = ncread('block00000025_new_median.nc','tomo_median');
...
clearvars im_resize num_img im ct_block
clc
ct_block = ncread('block00000070_median.nc','tomo_median');
im_resize = imresize(ct_block,0.43);
num_img = 40;
...
clearvars im_resize num_img im ct_block
clc
ct_block = ncread('block00000026_median.nc','tomo_median');
...
clearvars im_resize num_img im ct_block
clc
ct_block = ncread('SFH_Berea_median.nc','tomo_median');
